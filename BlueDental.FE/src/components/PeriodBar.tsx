...
interface Props {
  range: PeriodRange;
  /** Which options the switch offers; the reference varies per screen. */
...
/**
 * Ngày / Tuần / Tháng (/ Năm), a stepper, and a picker — the period control
 * the reference puts above every report and history list.
 *
 * Clicking the date opens a picker at the granularity of the period being
 * read — a year grid for Năm, a month grid for Tháng, and so on.
 */
export function PeriodBar({ range, periods }: Props) {
