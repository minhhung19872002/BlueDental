        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CancellationReason = table.Column<short>(type: "smallint", nullable: true),
                    CancellationNote = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_bd_appointments", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "bd_clinic_branches",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_bd_clinic_branches", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "bd_dental_procedures",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Code = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    ...
                    RequiresXray = table.Column<bool>(type: "boolean", nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    ExtraProperties = table.Column<string>(type: "text", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_bd_dental_procedures", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "bd_file_attachments",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_bd_file_attachments", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "bd_insurance_claims",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ...
                    claim_currency = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_bd_insurance_claims", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "bd_insurance_plans",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Code = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    ...
                    ProviderContactNumber = table.Column<string>(type: "text", nullable: true),
                    CoveragePercentage = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: false),
                    MaxAnnualBenefit = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    ExtraProperties = table.Column<string>(type: "text", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_bd_insurance_plans", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "bd_inventory_items",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_bd_inventory_items", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_bd_invoices", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_bd_medications", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "bd_notifications",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_bd_notifications", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MedicalAlerts = table.Column<string>(type: "text", nullable: true),
                    Status = table.Column<short>(type: "smallint", nullable: false),
                    BranchId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_bd_patients", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "bd_prescriptions",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TreatmentRecordId = table.Column<Guid>(type: "uuid", nullable: false),
                    PatientId = table.Column<Guid>(type: "uuid", nullable: false),
                    PrescribedBy = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_bd_prescriptions", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "bd_treatment_plans",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    PatientId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_bd_treatment_plans", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "bd_treatment_records",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ...
                    DentistId = table.Column<Guid>(type: "uuid", nullable: false),
                    ProcedureId = table.Column<Guid>(type: "uuid", nullable: true),
                    TeethTreated = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_bd_treatment_records", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_bd_appointments_BranchId_Status",
                table: "bd_appointments",
                columns: new[] { "BranchId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_bd_appointments_DentistId_Status",
                table: "bd_appointments",
                columns: new[] { "DentistId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_bd_appointments_PatientId_Status",
                table: "bd_appointments",
                columns: new[] { "PatientId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_bd_clinic_branches_Code",
                table: "bd_clinic_branches",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_bd_dental_procedures_Code",
                table: "bd_dental_procedures",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_bd_file_attachments_OwnerEntityType_OwnerEntityId",
                table: "bd_file_attachments",
                columns: new[] { "OwnerEntityType", "OwnerEntityId" });

            migrationBuilder.CreateIndex(
                name: "IX_bd_inventory_items_BranchId_ItemCode",
                table: "bd_inventory_items",
                columns: new[] { "BranchId", "ItemCode" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_bd_invoices_InvoiceNumber",
                table: "bd_invoices",
                column: "InvoiceNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_bd_notifications_RecipientUserId_DeliveryStatus",
                table: "bd_notifications",
                columns: new[] { "RecipientUserId", "DeliveryStatus" });

            migrationBuilder.CreateIndex(
                name: "IX_bd_patients_PatientCode",
                table: "bd_patients",
                column: "PatientCode",
                unique: true);
