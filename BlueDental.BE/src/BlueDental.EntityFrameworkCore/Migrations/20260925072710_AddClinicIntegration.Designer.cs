...
namespace BlueDental.Migrations
{
    ...
    [Migration("20260925072710_AddClinicIntegration")]
    partial class AddClinicIntegration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlueDental.Appointments.AppointmentChangeLog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("bd_appointment_change_logs", (string)null);
                });
            ...
            modelBuilder.Entity("BlueDental.ClinicIntegration.ClinicConnection", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("InvoiceSyncEnabled")
                        .HasColumnType("boolean");
                    ...
                    b.Property<DateTime?>("LastHandshakeTime")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<bool>("ServiceCatalogSyncEnabled")
                        .HasColumnType("boolean");
                    ...
                    b.ToTable("bd_clinic_connections", (string)null);
                });

            modelBuilder.Entity("BlueDental.ClinicIntegration.IntegrationCallLog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ClinicBranchId", "CreationTime");

                    b.ToTable("bd_integration_call_logs", (string)null);
                });

            modelBuilder.Entity("BlueDental.ClinicIntegration.ServiceCatalogSyncState", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("PartnerServiceId")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
                    ...
                    b.ToTable("bd_service_catalog_sync_states", (string)null);
                });
            ...
            modelBuilder.Entity("BlueDental.FileManagement.RichTextImage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("bd_rich_text_images", (string)null);
                });
            ...
            modelBuilder.Entity("BlueDental.Inventory.MaterialAllocationItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("MaterialAllocationId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("MaterialAllocationId");

                    b.ToTable("bd_material_allocation_items", (string)null);
                });
            ...
            modelBuilder.Entity("BlueDental.Labo.LaboMaterial", b =>
                {
                    ...
                    b.HasIndex("ClinicBranchId", "TaxonomyId");
            ...
            modelBuilder.Entity("BlueDental.Notifications.ClinicConfigure", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("BranchId", "Module", "IsEnabled");

                    b.ToTable("bd_clinic_configures", (string)null);
                });
            ...
            modelBuilder.Entity("BlueDental.Operations.OperationArticle", b =>
                {
                    ...
                    b.HasIndex("ClinicBranchId", "Department", "SubTab");
            ...
            modelBuilder.Entity("BlueDental.Organizations.BranchManagerAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ManagerId", "ClinicBranchId")
                        .IsUnique();

                    b.ToTable("bd_branch_manager_assignments", (string)null);
                });
            ...
            modelBuilder.Entity("BlueDental.PatientManagement.Patient", b =>
                {
                    ...
                    b.PrimitiveCollection<Guid[]>("DiseaseHistoryEntryIds")
                        .IsRequired()
                        .HasColumnType("uuid[]");
            ...
            modelBuilder.Entity("BlueDental.PatientManagement.PatientMedicalRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("bd_patient_medical_records", (string)null);
                });
            ...
            modelBuilder.Entity("BlueDental.Promotions.Voucher", b =>
                {
                    ...
                    b.PrimitiveCollection<string[]>("CustomerTargets")
                        .IsRequired()
                        .HasColumnType("text[]")
                    ...
                    b.Property<bool>("DisplayOnNfcDental")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool>("IsDaysOfWeekLimited")
                        .HasColumnType("boolean");
                    ...
                    b.Property<short>("ScopeTarget")
                        .HasColumnType("smallint");

                    b.Property<short>("Status")
                        .HasColumnType("smallint");

                    b.PrimitiveCollection<Guid[]>("TargetIds")
                        .IsRequired()
                        .HasColumnType("uuid[]")
                    ...
                    b.HasIndex("IsPublished", "Status", "ValidFrom", "ValidTo");

                    b.ToTable("bd_vouchers", (string)null);
                });

            modelBuilder.Entity("BlueDental.Queue.QueueTicket", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTimeOffset?>("ServingAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasIndex("ClinicBranchId", "QueueDate", "Status");

                    b.HasIndex("ClinicBranchId", "QueueDate", "TicketNumber")
                        .IsUnique();

                    b.ToTable("bd_queue_tickets", (string)null);
                });

            modelBuilder.Entity("BlueDental.Queue.ServiceCounter", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BlueDental.Tools.CallAssignment", b =>
                {
                    ...
                    b.HasIndex("ClinicBranchId", "Sip");

                    b.ToTable("bd_call_assignments", (string)null);
                });

            modelBuilder.Entity("BlueDental.Tools.CallConfiguration", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("bd_call_configurations", (string)null);
                });
            ...
            modelBuilder.Entity("BlueDental.Tools.CallLog", b =>
                {
                    ...
                    b.HasIndex("ClinicBranchId", "CalledAt");
            ...
            modelBuilder.Entity("BlueDental.TreatmentManagement.PatientDiagnosis", b =>
                {
                    ...
                    b.Property<string>("ContentDiagnosis")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("BlueDental.TreatmentManagement.PatientQuote", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("bd_patient_quotes", (string)null);
                });
            ...
            modelBuilder.Entity("BlueDental.TreatmentManagement.TreatmentService", b =>
                {
                    ...
                    b.Property<Guid?>("DiagnoserStaffId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("SecondDiagnoserStaffId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BlueDental.Catalogs.CatalogMedicine", b =>
                {
                    b.HasOne("BlueDental.Catalogs.CatalogEntry", null)
                        .WithOne("Medicine")
                        .HasForeignKey("BlueDental.Catalogs.CatalogMedicine", "CatalogEntryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("BlueDental.Catalogs.CatalogServiceConfig", b =>
                {
                    b.HasOne("BlueDental.Catalogs.CatalogEntry", null)
                        ...
                        .HasForeignKey("BlueDental.Catalogs.CatalogServiceConfig", "CatalogEntryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("BlueDental.Inventory.MaterialAllocationItem", b =>
                {
                    b.HasOne("BlueDental.Inventory.MaterialAllocation", null)
                        .WithMany("Items")
                        .HasForeignKey("MaterialAllocationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("BlueDental.TreatmentManagement.PatientQuote", b =>
                {
                    b.OwnsMany("BlueDental.TreatmentManagement.PatientQuoteLine", "Lines", b1 =>
                        {
                            b1.Property<Guid>("PatientQuoteId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("PatientQuoteId", "__synthesizedOrdinal");

                            b1.ToTable("bd_patient_quotes");

                            b1.ToJson("Lines");

                            b1.WithOwner()
                                .HasForeignKey("PatientQuoteId");
                        });
