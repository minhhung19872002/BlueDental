...
public class ConsultationRecordAppServiceContractTests
{
    private readonly Type _serviceType = typeof(ConsultationRecordAppService);
    private readonly Type _interfaceType = typeof(IConsultationRecordAppService);

    [Fact]
    public void ConsultationRecordAppService_Should_Implement_IConsultationRecordAppService()
    {
        _interfaceType.IsAssignableFrom(_serviceType).ShouldBeTrue();
    }

    [Fact]
    public void ConsultationRecordAppService_Should_Inherit_ApplicationService()
    {
        typeof(ApplicationService).IsAssignableFrom(_serviceType).ShouldBeTrue();
    }

    [Fact]
    public void ConsultationRecordAppService_Should_Require_Authorization_At_Class_Level()
    {
