...
public class ClinicBranchAppServiceContractTests
{
    private readonly Type _serviceType = typeof(ClinicBranchAppService);
    private readonly Type _interfaceType = typeof(IClinicBranchAppService);

    [Fact]
    public void ClinicBranchAppService_Should_Implement_IClinicBranchAppService()
    {
        _interfaceType.IsAssignableFrom(_serviceType).ShouldBeTrue();
    }

    [Fact]
    public void ClinicBranchAppService_Should_Inherit_ApplicationService()
    {
        typeof(ApplicationService).IsAssignableFrom(_serviceType).ShouldBeTrue();
    }

    [Fact]
    public void ClinicBranchAppService_Should_Require_Authorization_At_Class_Level()
    {
